...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Triangle_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("5639c1d2-226c-5e70-8d55-b3095415a16a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Triangle", artifacts_toml) for e in artifacts["Triangle"]]
...
if best_platform === nothing
    @debug("Unable to load Triangle; unsupported platform $(triplet(platform_key_abi()))")
else
