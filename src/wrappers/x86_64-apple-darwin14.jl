# Autogenerated wrapper script for Triangle_jll for x86_64-apple-darwin14
export libtriangle
...
const libtriangle_splitpath = ["lib", "libtriangle.dylib"]
...
const libtriangle = "@rpath/libtriangle.dylib"
